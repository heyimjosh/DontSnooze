...
public struct UserNotificationClient {
  ...
  public var getPendingNotificationRequests: @Sendable () async -> [UNNotificationRequest] = { [] }
  public var removeAllDeliveredNotifications: @Sendable () async -> Void
  public var removeAllPendingNotifications: @Sendable () async -> Void
